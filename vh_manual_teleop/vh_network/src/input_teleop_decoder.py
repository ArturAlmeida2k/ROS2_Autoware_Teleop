...
class InputTeleopDecoder(Node):
    def __init__(self): 
        ...
        self.pub_turn_signal = self.create_publisher(Int32, '/teleop/turn_signal', 10)
    ...
    def receive_packet(self):
        try:
            ...
            vlc, steer, brake, gear, signal, engage = struct.unpack('fffii?', data)
            ...
            self.pub_turn_signal.publish(Int32(data=signal))
...
class InputTeleopDecoder(Node):
    def __init__(self):
        ...
        self.create_timer(0.01, self.receive_packet)  # 100Hz para não perder pacotes
